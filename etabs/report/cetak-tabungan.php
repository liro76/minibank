...
<body>
    <center>
        ...
        <h3>SDN 2 Bungur Raya</h3>
        <p>Jl. Raya Bungur RT 003 RW 001 Desa Bungur Raya</p>
        ...
        ?>
            ...
            <tr>
                <td colspan="2">Saldo (dari tb_siswa)</td>
                <td colspan="3">
                    <?php
                    $sql = $koneksi->query("SELECT saldo FROM tb_siswa WHERE nis='$nis'");
