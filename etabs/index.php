...
<body class="hold-transition skin-red sidebar-mini">
	...
	<div class="wrapper">
        ...
        ?>
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							...
							<li>
								<a href="?page=laporan">
									<i class="fa fa-arrow-circle-o-down"></i>Laporan Rekap</a>
							</li>
							<li>
								<a href="?page=laporan1">
									<i class="fa fa-arrow-circle-o-up"></i>Laporan Detail</a>
							</li>
							<li>
								<a href="?page=laporan_harian">
									<i class="fa fa-arrow-circle-o-up"></i>Laporan harian</a>
							</li>
						</ul>
					</li>
      ...
      if(isset($_GET['page'])){
          ...
          switch ($hal) {
			...
			//Siswa
              case 'MyApp/data_siswa1':
                  include "petugas/siswa/data_siswa1.php";
                  break;
				case 'MyApp/add_siswa1':
                  include "petugas/siswa/add_siswa1.php";
                  break;
              case 'MyApp/edit_siswa1':
                  include "petugas/siswa/edit_siswa1.php";
                  break;
              case 'MyApp/del_siswa1':
                  include "petugas/siswa/del_siswa1.php";
				  break;  
              ...
              case 'del_tarik':
				...
				case 'laporan':
					...
					break;
				case 'laporan1':
					include "petugas/laporan/view_laporan1.php";
					break;
				case 'laporan_harian':
    ...
    ?>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; <?php echo date("Y"); ?> BANK MINI SMKN 18 JAKARTA
		</footer>
